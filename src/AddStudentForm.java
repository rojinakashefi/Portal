    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == applyBtn) {
            if (username == null || password == null || username.length() <= 0 || password.length() <= 0) {
                ...
                accountService.addUser(username, password, UserRole.Student);
                passwordTxt.setText("");
                userNameTxt.setText("");
                accountService.printUsers();
                JOptionPane.showMessageDialog(this, "New Student User is successfully added");
            }
